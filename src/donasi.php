...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($stmt->execute()) {
    ...
    echo "<script>alert('Donasi berhasil! " . $nama_lengkap . "'); window.location.src = '../sukses.html';</script>";
  } else {
...
<body>
  <div id="donation-forms">
    ...
    <div id="donation-form-2" class="donation-form-overlay hidden">
      <div class="donation-form-container">
        <button class="back-btn" id="back-btn-2">&larr; Kembali</button>
    ...
    <div id="donation-form-3" class="donation-form-overlay hidden">
      <div class="donation-form-container">
        <button class="back-btn" id="back-btn-3">&larr; Kembali</button>
